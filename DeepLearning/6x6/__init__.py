...
from DeepLearning6x6.DaB_Model import DaB_CNN, DaB_ResNet, DaB_LSTM, DaB_ConvLSTM, DaB_Conv2Plus1D
...
class BaseBot():
    ...
    def train_from_json(self):
        def gen_data(his, type: 0, game_result):
        ...
        for game_his in all_game_history:
            current_data = gen_data(his = game_his["history"], type=0, game_result=game_his["winner"])
            data += current_data
